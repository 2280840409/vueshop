    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="操作" width="130px">
          <template>
            <el-button type="primary" icon="el-icon-edit" size="mini" @click="showAddDialog"></el-button>
            <el-button type="success" icon="el-icon-location" size="mini" @click="showRessDialog"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
      ...
      <!--地址对话框 -->
      <el-dialog title="提示" :visible.sync="ressdialogVisible" width="50%">
        <span>这是一段信息</span>
      </el-dialog>
    </el-card>
  </div>
...
export default {
  ...
  methods: {
    ...
    async showRessDialog() {
      const res = await this.request({
        url: "/kuaidi/1106975712662",
      });
      this.ressInfo = res.data;
      console.log(this.ressInfo);
      this.ressdialogVisible = true;
    },
  },
};
</script>
